...
static uint64_t getAttrKindEncoding(Attribute::AttrKind Kind) {
  ...
  // secgap
  case Attribute::SecDSE:
    return bitc::ATTR_KIND_SECDSE;
  // secgap
  case Attribute::NoDSE:
    return bitc::ATTR_KIND_NODSE;
  // secgap
  case Attribute::BCounter:
    return bitc::ATTR_KIND_BCOUNTER;
  // secgap
  case Attribute::BCounterAll:
    return bitc::ATTR_KIND_BCOUNTERALL;
