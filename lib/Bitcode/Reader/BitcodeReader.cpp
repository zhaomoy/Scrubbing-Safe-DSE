...
static Attribute::AttrKind getAttrFromCode(uint64_t Code) {
  ...
  // secgap
  case bitc::ATTR_KIND_SECDSE:
    return Attribute::SecDSE;
  // secgap
  case bitc::ATTR_KIND_NODSE:
    return Attribute::NoDSE;
  // secgap
  case bitc::ATTR_KIND_BCOUNTER:
    return Attribute::BCounter;
  // secgap
  case bitc::ATTR_KIND_BCOUNTERALL:
    return Attribute::BCounterAll;
