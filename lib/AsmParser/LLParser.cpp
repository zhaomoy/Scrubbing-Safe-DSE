...
bool LLParser::ParseFnAttributeValuePairs(AttrBuilder &B,
  ...
  while (true) {
    ...
    // secgap
    case lltok::kw_bcounter: B.addAttribute(Attribute::BCounter); break;
    // secgap
    case lltok::kw_bcounterall: B.addAttribute(Attribute::BCounterAll); break;
    ...
    // secgap
    case lltok::kw_nodse: B.addAttribute(Attribute::NoDSE); break;
    ...
    // secgap
    case lltok::kw_secdse: B.addAttribute(Attribute::SecDSE); break;
...
bool LLParser::ParseOptionalParamAttrs(AttrBuilder &B) {
  ...
  while (1) {
    ...
    // secgap
    case lltok::kw_bcounter:
    // secgap
    case lltok::kw_bcounterall:
