...
std::string Attribute::getAsString(bool InAttrGrp) const {
  ...
  if (hasAttribute(Attribute::SafeStack))
    return "safestack";
  // secgap
  if (hasAttribute(Attribute::SecDSE))
    return "secdse";
  if (hasAttribute(Attribute::NoDSE))
    return "nodse";
  if (hasAttribute(Attribute::BCounter))
      return "bcounter";
  if (hasAttribute(Attribute::BCounterAll))
      return "bcounterall";
...
uint64_t AttributeImpl::getAttrMask(Attribute::AttrKind Val) {
  ...
  // secgap
  case Attribute::SecDSE:          return 1ULL << 54;
  case Attribute::NoDSE:           return 1ULL << 55;
  case Attribute::BCounter:        return 1ULL << 56;
  case Attribute::BCounterAll:     return 1ULL << 57;
